...
while True:
    ...
    if keys[pygame.K_ESCAPE]:
        ...
        start_program_og_musikk_stopp("Underprogram/kube_pi_treg.py")
    elif keys[pygame.K_r]:
        start_program_og_musikk_stopp("Underprogram/kube_pi.py")
    elif keys[pygame.K_t]:
        start_program_og_musikk_stopp("Underprogram/Forklaring.py")
    elif keys[pygame.K_k]:
        start_program_og_musikk_stopp("Underprogram/kube_pi_forklaring.py")
    elif keys[pygame.K_i]:
        start_program_og_musikk_stopp("Underprogram/info_program.py")
